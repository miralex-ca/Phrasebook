...
public class ImgGroupPickerAdapter extends RecyclerView.Adapter<ImgGroupPickerAdapter.MyViewHolder> {
    ...
    public ImgGroupPickerAdapter(Context context, String[] pics, int selected) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.img_group_picker_item, parent, false);
